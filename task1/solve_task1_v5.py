"""
Task 1 v5: ChEBI Multi-Label Classification - SGDClassifier with log_loss
"""
...
def main():
    t0 = time.time()
    print("Task 1 v5: ChEBI (SGD log_loss)", flush=True)
    ...
    print("Training 500 SGD classifiers...", flush=True)
